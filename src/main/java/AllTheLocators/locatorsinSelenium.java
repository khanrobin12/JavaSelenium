...
public class locatorsinSelenium {
	...
	public static void main(String[] args) {
		...
		driver.get("https://naveenautomationlabs.com/opencart/index.php?route=account/login"); // page will wait until
																								// the elements load.

		// 8 locators:
		// id, name, classname, xpath, css selector, linktext, partial link text, tag
		// name
...
//				By emailId = By.name("email");
		...
		// 3. class name: can be duplicate most of the time - not recommended if its
		// duplicate
